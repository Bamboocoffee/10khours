...
ActiveRecord::Schema.define(version: 2019_06_17_204736) do
  ...
  create_table "from_scratches", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "activity2"
    t.string "activity3"
    t.integer "activity1_time"
    t.integer "activity2_time"
    t.integer "activity3_time"
    t.string "name"
